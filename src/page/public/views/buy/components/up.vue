  ...
  methods: {
    lossRemove() {
      ...
      if (this.lossNum === "未设置" || this.lossNum === "") {
        this.lossNum = this.subtr(this.lastPrice, this.data.minWave);
        return;
      }
    ...
    profitRemove() {
      ...
      if (this.profitNum === "未设置" || this.profitNum === "") {
        this.profitNum = this.addNum(this.lastPrice, this.data.minWave);
        return;
      }
      if (this.profitNum <= this.minProfit) return;
    ...
    confrim() {
      ...
      if (
        ...
        this.$vux.toast.text("止损价不能高最新价", "middle");
        return;
      }

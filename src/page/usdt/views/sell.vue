  ...
  <div class="usdtlist fixd-wrap">
          ...
          <div class="list-content">
            <div class="list-content-name">
              <div class="list-content-name-left">
                <span>{{ $t("dialog.usdtBuy.price2") }}</span>
                ≈{{ item.price }}{{ item.currencySymbol }}/USDT
              </div>
    ...
    <popup v-model="purchase" position="bottom" height="90%" class="buy-popup" :hide-on-blur="false">
      <div style="padding: .3rem .2rem 0 .2rem; background:rgb(32,42,51);height:100%;">
        ...
        <sellOut :item="item" ref="sell"></sellOut>
...
export default {
  ...
  methods: {
    ...
    getbank() {
      // console.log('sdsfdsdd',this.banks);
      const _this = this;
    ...
    buy(item) {
      if (!this.userInfo.realAuth) {
        this.$router.push("/setting/realname");
        return false;
      }
      ...
      if (this.banks.length <= 0) {
        this.$router.push("/setting/add-card");
        return false;
      }
